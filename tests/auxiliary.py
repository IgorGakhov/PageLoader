...
CSS_URL: Final[str] = 'https://page-loader.hexlet.repl.co/assets/application.css'
JS_URL: Final[str] = 'https://page-loader.hexlet.repl.co/script.js'
IMAGE_URL: Final[str] = 'https://page-loader.hexlet.repl.co/assets/professions/nodejs.png'
...
IMAGE_FIXTURE: Final[str] = 'tests/fixtures/mocks/assets-professions-nodejs.png'
